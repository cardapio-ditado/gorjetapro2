/*
  # Corrigir Ambiguidade nas Variáveis da Função de Atualização de Status

  ## Problema
  A função atualizar_status_conta_pagar() tem variáveis locais com mesmo nome das colunas da tabela,
  causando erro "column reference is ambiguous"

  ## Solução
  Renomear variáveis locais para evitar conflito com nomes de colunas
...
BEGIN
  ...
  SET 
    ...
    data_baixa_integral = CASE 
      ...
      ELSE NULL
    END,
    saldo_restante = v_valor_total - v_total_pago,
    atualizado_em = now()
