/*
  # Zerar estoque e recarregar com compras de dezembro/2024
  
  ## Objetivo
  Zerar todos os saldos de estoque e reprocessar apenas as compras recebidas em dezembro de 2024.
  ...
  3. Reprocessar todas as entradas de compras recebidas em dezembro/2024
  ...
  - Reconstrói apenas os saldos e movimentações de dezembro/2024
*/
...
-- Passo 3: Reprocessar compras de dezembro/2024
DO $$
DECLARE
    compra_rec RECORD;
    item_rec RECORD;
...
BEGIN
    -- Loop através de todas as compras recebidas em dezembro/2024
    FOR compra_rec IN 
        SELECT 
            id,
            estoque_destino_id,
        ...
        WHERE status = 'recebido'
          AND EXTRACT(YEAR FROM data_compra) = 2024
    ...
    RAISE NOTICE 'Estoque zerado e recarregado com compras de dezembro/2024';
...
WHERE tipo_movimentacao = 'entrada' 
  AND motivo = 'Entrada por compra'
  AND EXTRACT(YEAR FROM data_movimentacao) = 2024
