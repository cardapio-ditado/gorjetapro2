/*
  # Apply Financial Categories Migration
  
  This migration creates the hierarchical financial categories structure
  and the required views for the application to function properly.
  
  1. Tables
    - Updates categorias_financeiras with hierarchy support
    
  2. Views  
    - Creates vw_categoria_tree for category hierarchy display
    - Creates vw_dre_consolidado for financial reporting
    
  3. Sample Data
    - Inserts sample hierarchical categories
*/
