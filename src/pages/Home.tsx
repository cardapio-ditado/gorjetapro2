...
const MODULOS: Modulo[] = [
  ...
  { slug: 'cadastros', nome: 'Cadastros', descricao: 'Funcionários, veículos, produtos, fornecedores, categorias e contas', icone: FolderCog, rota: '/cadastros' },
  { slug: 'eventos', nome: 'Eventos', descricao: 'Hub do evento: dados, estoque por área e financeiro', icone: CalendarDays, rota: '/eventos' },
  { slug: 'financeiro', nome: 'Financeiro Central', descricao: 'A pagar/receber, fluxo de caixa e conciliação bancária', icone: Landmark, rota: '/financeiro' },
