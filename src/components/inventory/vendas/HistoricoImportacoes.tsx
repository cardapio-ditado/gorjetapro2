    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-[#0d0f1a] border border-white/10 rounded-2xl shadow-2xl w-full max-w-5xl max-h-[90vh] flex flex-col overflow-hidden">
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-3">
                      <div>
                        <p className="text-xs text-white/60 mb-0.5">Importado em</p>
                      ...
                      <div>
                        <p className="text-xs text-white/60 mb-0.5">Total de itens</p>
                        <p className="text-sm text-white flex items-center gap-1">
                      ...
                      <div>
                        <p className="text-xs text-white/60 mb-0.5">Taxa de sucesso</p>
                      ...
                      <div>
                        <p className="text-xs text-white/60 mb-0.5">Tamanho</p>
        ...
        <div className="px-6 py-4 border-t border-white/10 flex items-center justify-between">
          {totalPaginas > 1 ? (
            <>
              <p className="text-sm text-white/60">Página {paginaAtual} de {totalPaginas}</p>
